...
const Profile = () => {
  ...
  const user = {
    name: "Samantha Jones",
    username: "@samanthaj",
    bio: "Web Producer | Web Specialist | Columbia University • New York",
  ...
  useEffect(() => {
    ...
    axios.get(`${import.meta.env.VITE_API_URL}/following/${DBUser?.uid}`)
      .then((res) => {
        ...
        loading ?
          ...
          <div className="min-h-screen bg-base-200 ">
            ...
            <div className=" max-w-5xl mx-auto px-6 md:px-12 pt-20 pb-12">
              {/* User Info */}
              <div className="mb-8">
                <h1 className="text-4xl md:text-5xl font-bold">{DBUser?.name}</h1>
